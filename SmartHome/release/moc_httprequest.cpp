...
#include "../misc/TTS/httprequest.h"
...
QT_MOC_LITERAL(1, 12, 14), // "requestSuccess"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 11), // "requestFail"
QT_MOC_LITERAL(4, 40, 11), // "replyFinish"
QT_MOC_LITERAL(5, 52, 14) // "QNetworkReply*"

    },
    "HttpRequest\0requestSuccess\0\0requestFail\0"
...
void HttpRequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestSuccess(); break;
        case 1: _t->requestFail(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpRequest::requestSuccess)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (HttpRequest::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpRequest::requestFail)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HttpRequest::requestSuccess()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void HttpRequest::requestFail()
{
