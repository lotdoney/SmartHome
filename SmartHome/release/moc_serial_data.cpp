/****************************************************************************
** Meta object code from reading C++ file 'serial_data.h'
**
...
#error "The header file 'serial_data.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 10), // "readFinish"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 12), // "slotSendData"
QT_MOC_LITERAL(4, 36, 12) // "slotReadData"

    },
    "SerialPort\0readFinish\0\0slotSendData\0"
    "slotReadData"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readFinish(); break;
        case 1: _t->slotSendData(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialPort::readFinish)) {
                *result = 0;
                return;
            }
        }
